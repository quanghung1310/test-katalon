...
WebUI.click(findTestObject('Page_surveybot - hoa3 Mattermost/button_Notifications'))

WebUI.click(findTestObject('Page_surveybot - hoa3 Mattermost/h4_Desktop Notifications'))

WebUI.click(findTestObject('Page_surveybot - hoa3 Mattermost/input_Send desktop notifications_desktopNotificationLevel'))
