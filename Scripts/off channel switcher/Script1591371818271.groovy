...
WebUI.click(findTestObject('Page_surveybot - hoa3 Mattermost/button_Sidebar'))

WebUI.click(findTestObject('Page_surveybot - hoa3 Mattermost/span_Channel Switcher'))

WebUI.click(findTestObject('Page_surveybot - hoa3 Mattermost/input_On_channelSwitcher'))
