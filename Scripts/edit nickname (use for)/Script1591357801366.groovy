...
for(int row =1; row <= findTestData('edit nickname').getRowNumbers();row++){
	
WebUI.click(findTestObject('Page_Town Square - team6 Mattermost/h4_Nickname'))

WebUI.setText(findTestObject('Page_Town Square - team6 Mattermost/input_Nickname_nickname'), findTestData('edit nickname').getValue('nickname', row))
