...
WebUI.click(findTestObject('Page_surveybot - hoa3 Mattermost/span_Channel Display'))

WebUI.click(findTestObject('Page_surveybot - hoa3 Mattermost/input_Full width_channel_display_modeFormat'))
