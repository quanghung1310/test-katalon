...
WebUI.click(findTestObject('Page_surveybot - hoa3 Mattermost/span_Message Display'))

WebUI.click(findTestObject('Page_surveybot - hoa3 Mattermost/input__message_displayFormat'))
