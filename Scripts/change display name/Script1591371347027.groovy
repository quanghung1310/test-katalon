...
WebUI.click(findTestObject('Page_surveybot - hoa3 Mattermost/span_Teammate Name Display'))

WebUI.click(findTestObject('Page_surveybot - hoa3 Mattermost/input_Show nickname if one exists otherwise show first and last name_name_formatFormat'))
