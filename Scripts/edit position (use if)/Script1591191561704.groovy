...
WebUI.click(findTestObject('Object Repository/Page_hello - teamm5 Mattermost/path'))
...
WebUI.setText(findTestObject('Object Repository/Page_hello - teamm5 Mattermost/input_Position_position'), 'admin')
