...
WebUI.click(findTestObject('Page_surveybot - hoa3 Mattermost/span_Theme'))

WebUI.click(findTestObject('Page_surveybot - hoa3 Mattermost/img_Mattermost Dark_img-responsive'))
