...
WebUI.click(findTestObject('Object Repository/Page_hello - teamm5 Mattermost/button_admin_style--none sidebar-header-dro_b41f5f'))

WebUI.click(findTestObject('Object Repository/Page_hello - teamm5 Mattermost/span_Log Out'))
}
else
