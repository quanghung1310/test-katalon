...
for(int row =1; row <= findTestData('edit position').getRowNumbers();row++){
WebUI.click(findTestObject('Page_Town Square - team6 Mattermost/h4_Position'))

WebUI.setText(findTestObject('Page_Town Square - team6 Mattermost/input_Position_position'), 
	findTestData('edit position').getValue('role', row))
