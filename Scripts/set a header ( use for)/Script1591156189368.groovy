...
for (int row = 1; row <= findTestData('change header').getRowNumbers(); row++) {
    WebUI.click(findTestObject('Page_Town Square - teamm5 Mattermost/button_Set a Header'))

    WebUI.setText(findTestObject('Page_Town Square - teamm5 Mattermost/textarea_Edit the Channel Header_edit_textbox'), 
        findTestData('change header').getValue('header', row))
